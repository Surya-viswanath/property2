...
const Showrqst = () => {
    ...
    useEffect(() => {
        const fetchRequests = async () => {
            try {
                const res = await axios.get('https://property1-uoj3.onrender.com/request-organizer');
                setRequest(res.data);
            } catch (error) {
            ...
            if (result.isConfirmed) {
                ...
                // axios.put(`http://localhost:4008/getcustomer/organizer/${userId}`).then((res) => {
                    ...
                    // if (res.data.role === 'organizer') {
                        ...
                        axios.put(`https://property1-uoj3.onrender.com/request-organizer/accept/${id}`).then((res) => {
                            console.log("hey",id);
                            if (res.data.status === 'accepted') {
                                ...
                                axios.put(`https://property1-uoj3.onrender.com/update-user/${userId}`, { role: 'organizer' })
                                .then(response => {
    ...
    const handleReject = (id) => {
        console.log("hey",id);
        axios.put(`https://property1-uoj3.onrender.com/request-organizer/reject/${id}`).then((res) => {
