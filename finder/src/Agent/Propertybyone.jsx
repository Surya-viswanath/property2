        ...
        <Card style={{ width: '100%', height: '400px' }}>
          ...
          <Card.Body>
            <Card.Text className="textp">
              ...
              <button onClick={() => handleDelete(property._id)} style={{color:'rgb(239, 94, 78)',backgroundColor:'white',border:'1px solid rgb(239, 94, 78)',borderRadius:'5px'}}>Delete</button>
            </Card.Text>
          </Card.Body>
        </Card>
      </Col>
