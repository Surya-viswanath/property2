...
const handleSubmit =async(event)=>{
    ...
    try{
    const display =await axios.post('http://localhost:4008/createpro',{userId: user._id,description,address,regularPrice,discountPrice,bathrooms,bedrooms,furnished,parking,type,offer,propertysize,phone,email,image,location,sell})
