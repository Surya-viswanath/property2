...
const handleSubmit =async(event)=>{
    ...
    try{
    const display =await axios.post('https://property1-uoj3.onrender.com/createpro',{userId: user._id,description,address,regularPrice,discountPrice,bathrooms,bedrooms,furnished,parking,type,offer,propertysize,phone,email,image,location,sell})
