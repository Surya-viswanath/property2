...
const DashboardHome = () => {
  ...
  return (
    <div className="dashboard-grid">
      {widgets.totalOrder && (
        <Widget
          icon={<HiOutlineEye className="widget-icon icon-indigo" size={30} />}
          title="Total Order"
          count={totalProductsOrder}
        />
      )}
      ...
      {widgets.totalBookings && (
        <Widget
          icon={<HiOutlineClock className="widget-icon icon-green" size={30} />}
          title="Total Bookings"
          count={totalBookings_Payment}
        />
      )}
      ...
      {widgets.totalPayment && (
        <Widget
          icon={<MdOutlinePayment className="widget-icon icon-primary" size={30} />}
          title="Total Payment"
          count={totalBookings_Payment}
        />
      )}
      ...
      {widgets.totalReview && (
        <Widget
          icon={<MdOutlineReviews className="widget-icon icon-amber" size={30} />}
          title="Total Review"
          count={totalReview}
        />
      )}
...
const Widget = ({ icon, title, count }) => (
  <div className="widget-container">
    <div className="widget-icon-container">{icon}</div>
    <h4 className="widget-count">{count}</h4>
